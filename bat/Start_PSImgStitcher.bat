...
REM ==========================================================
REM  PSImgStitcher launcher (PowerShell edition)
...
if not exist "PSImgStitcher.ps1" (
    echo ERROR: PSImgStitcher.ps1 not found in this folder:
    echo    %CD%
    pause
    exit /b 1
)
...
%PS_CMD% ^
    -NoProfile ^
    -ExecutionPolicy Bypass ^
    -File "%PS1_DIR%PSImgStitcher.ps1"
